      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end m-2 p-2">
          <Link
            ...
            class="px-4 bg-indigo-500 hover:bg-indigo-700 text-white rounded-md"
            >New Skill</Link
          >
        </div>
        ...
        <div class="relative overflow-x-auto">
          ...
          >
            ...
            <tbody>
              <tr
                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="skill in skills.data" :key="skill.id"
              >
                <th
                  scope="row"
                ...
                <td class="px-6 py-4">
                    ...
                    <Link :href="route('skills.destroy',skill.id)" class="font-medium text-red-500 hover:red-blue-700 mr-2"
                    method="delete"
                    as="button"
